...
print("aaaaaaaaaaa".replace("a", "b"))  # 'bbbbbbbbbbb'
print("aaaaaaaaaaa".replace("a", "b", 2))  # 'bbaaaaaaaaa'


# Assignment: Check how to replace from right to left
print("aaaaaaaaaaa".replace("a", "b", 2)[::-1])  # 'aaaaaaaaabb'
