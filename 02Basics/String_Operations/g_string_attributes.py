...
#str.isnumeric
''' Recognizes numeric characters beyond just 0-9, 
including superscript and subscript digits, fraction digits, and 
other numeric characters in various scripts '''

print('"1/2".isnumeric()    :', "1/2".isnumeric()) #False
print('"వందనం".isnumeric()    :', "వందనం".isnumeric())#False
print('"౧౨౩౪౫".isnumeric()  :', "౧౨౩౪౫".isnumeric()) #True
print('"¼".isnumeric()  :',"¼".isnumeric()) #True
print()

#str.isdigit
'''Does not recognize numeric characters other than 0-9'''

print('"1/2".isdigit()    :', "1/2".isdigit()) #False
print('"వందనం".isdigit()    :', "వందనం".isdigit())#False
print('"౧౨౩౪౫".isdigit()  :', "౧౨౩౪౫".isdigit()) #True
